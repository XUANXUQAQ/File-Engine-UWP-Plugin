...
import file.engine.uwp.Plugin;
import file.engine.uwp.utils.gson.GsonUtil;
...
public class VersionUtil {
    ...
    private static Map<String, Object> getVersionInfo() throws IOException {
        String url = "https://cdn.jsdelivr.net/gh/XUANXUQAQ/File-Engine-Version/Plugins%20Repository/UWPPluginVersion.json";
        String savePath = "tmp";
        String fileName = "UWPPluginVersion.json";
        try {
